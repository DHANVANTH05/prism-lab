    ...
    <div className="page-enter">
      <div className="page-header">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="font-body font-bold text-5xl text-white mb-4">Lab Director</h1>
        </div>
      </div>
            ...
            <div className="w-40 h-40 rounded-2xl overflow-hidden bg-[#0f2044]/5 dark:bg-white/5 flex-shrink-0 flex items-center justify-center">
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.parentElement.innerHTML = `<span class="font-bold text-5xl text-[#0f2044]/20 dark:text-white/20">SD</span>`
                }}
              />
            </div>
            <div className="flex-1">
              <h2 className="font-body font-bold text-4xl text-[#0f2044] dark:text-white mb-1">
                {director.name}
              </h2>
              <p className="font-semibold text-[#0f2044] dark:text-white mb-0.5">
                {director.title}
              </p>
              <p className="font-semibold text-[#0f2044]/60 dark:text-white/40 mb-5">
                {director.department}
              </p>
              ...
              <div className="flex flex-wrap gap-5 text-sm text-[#6b7a94] dark:text-white/50">
                <a
                  ...
                  className="flex items-center gap-2 hover:text-[#0f2044] dark:hover:text-white transition-colors"
                >
